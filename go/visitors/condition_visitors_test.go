...
func TestVisitConsentCondition(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"Department consent required": {
			...
			Result: conditions2.NewConsentCondition(constants.DepartmentConsent),
		},
		"UTeach advisor consent required": {
			Input:  "UTeach advisor consent required",
			Result: conditions2.NewConsentCondition(constants.UTeachConsent),
		},
	}

	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Consent_condition), tc.Result)
		})
	}
}
...
func TestVisitStandingCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Upper-division standing": {
			...
			Result: conditions2.NewGenericStandingCondition(constants.UpperDivisionStanding),
		},
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Standing_condition), tc.Result)
		})
	}
}
...
func TestVisitSimpleGradeCondition(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"Basic": {
			...
			Result: conditions2.NewCourseCondition(
				"ACCT", "2301", "C"),
		},
		"Or Better": {
			Input:  "ANGM 3370 with a grade of B or higher",
			Result: conditions2.NewCourseCondition("ANGM", "3370", "B"),
		},
		"Short Hand Course": {
			Input: "CS/CE 2305 with a minimum grade of C",
			Result: conditions2.NewOrCondition(
				conditions2.NewCourseCondition("CS", "2305", "C"),
				conditions2.NewCourseCondition("CE", "2305", "C"),
			),
		},
		"GPA": {
			Input:  "MATH 2413 with a grade greater than or equal to C- (1.67)",
			Result: conditions2.NewCourseCondition("MATH", "2413", "C-"),
		},
		"Grade List": {
			Input: "(CE 2336 or CS 2336 or CS 2337) with a grade of C or better",
			Result: conditions2.NewOrCondition(
				conditions2.NewCourseCondition("CE", "2336", "C"),
				conditions2.NewCourseCondition("CS", "2336", "C"),
				conditions2.NewCourseCondition("CS", "2337", "C"),
			),
		},
		"At least Grade in": {
			Input: "a grade of at least a C- in MATH 1314 and MATH 1316",
			Result: conditions2.NewAndCondition(
				conditions2.NewCourseCondition("MATH", "1314", "C-"),
				conditions2.NewCourseCondition("MATH", "1316", "C-"),
			),
		},
	}
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Grade_condition), tc.Result)
		})
	}
...
func TestVisitAlternateCondition(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"Single Course": {
			...
			Result: conditions2.NewAlternativeCondition(
				conditions2.NewCourseCondition("BIOL", "2311", ""),
			),
		},
		...
		"Multiple Courses": {
			...
			Result: conditions2.NewAlternativeCondition(
				conditions2.NewOrCondition(
					conditions2.NewCourseCondition("PHIL", "1301", ""),
					conditions2.NewCourseCondition("PHIL", "1305", ""),
					conditions2.NewCourseCondition("PHIL", "1306", ""),
				),
			),
		},
	}
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Alternative_condition), tc.Result)
		})
	}
}
...
func TestVisitGradeLevelStandingCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Senior History Major standing": {
			...
			Result: conditions2.NewGradeLevelConditionWithDegree(constants.Senior, "History"),
		},
		"Minimum of Sophomore standing": {
			Input:  "Minimum of Sophomore standing",
			Result: conditions2.NewGradeLevelCondition(constants.Sophomore),
		},
		"At least Senior-level Standing": {
			Input:  "At least Senior-level Standing",
			Result: conditions2.NewGradeLevelCondition(constants.Senior),
		},
		"PSY Majors Only with Junior or Senior standing": {
			Input: "PSY Majors Only with Junior or Senior standing",
			Result: conditions2.NewOrCondition(
				conditions2.NewGradeLevelConditionWithDegree(constants.Junior, "PSY"),
				conditions2.NewGradeLevelConditionWithDegree(constants.Senior, "PSY"),
			),
		},
	}
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Grade_level_standing_condition), tc.Result)
		})
	}
...
func TestVisitGraduateStandingCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Graduate standing in Biology": {
			...
			Result: conditions2.NewGraduateStandingInConditionWithDegree("Biology"),
		},
		"Graduate standing in Chemistry": {
			Input:  "Graduate standing in chemistry",
			Result: conditions2.NewGraduateStandingInConditionWithDegree("chemistry"),
		},
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Graduate_standing_condition), tc.Result)
		})
	}
}
...
func TestVisitGpaCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Minimum GPA requirement": {
			...
			Result: conditions2.NewGpaCondition(3.200),
		},
		"GPA in course": {
			Input:  "a GPA of 3.000 or better in UTeach coursework",
			Result: conditions2.NewGpaConditionWithDegree(3.000, "UTeach"),
		},
	}

	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Gpa_condition), tc.Result)
		})
	}
}
...
func TestVisitMajorCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Single prefix majors only": {
			...
			Result: conditions2.NewMajorCondition("ENCS"),
		},
		"Multiple prefixes": {
			Input: "EE or CE or TE major",
			Result: conditions2.NewOrCondition(
				conditions2.NewMajorCondition("EE"),
				conditions2.NewMajorCondition("CE"),
				conditions2.NewMajorCondition("TE"),
			),
		},
		"Prefix with degree type": {
			Input:  "BBSC GRAD majors only",
			Result: conditions2.NewMajorConditionWithDegreeLevel("BBSC", constants.Graduate),
		},
		"Prefixes with grade level": {
			Input: "CE or EE Freshman Majors only",
			Result: conditions2.NewOrCondition(
				conditions2.NewMajorConditionWithGradeLevel("CE", constants.Freshman),
				conditions2.NewMajorConditionWithGradeLevel("EE", constants.Freshman),
			),
		},
		"Prefix with degree level": {
			Input:  "ENCS PhD majors only",
			Result: conditions2.NewMajorConditionWithDegreeLevel("ENCS", constants.PhD),
		},
		"Grade level prefix major": {
			Input:  "Freshman ENCS Majors only",
			Result: conditions2.NewMajorConditionWithGradeLevel("ENCS", constants.Freshman),
		},
		"Degree type prefix major": {
			Input:  "MS ITM Major only",
			Result: conditions2.NewMajorConditionWithDegreeLevel("ITM", constants.Graduate),
		},
		"Named major": {
		...
		"Named major only": {
			...
			Result: conditions2.NewMajorCondition("Visual and Performing Arts"),
		},
		"Named degree type major": {
			Input:  "International Management Studies PhD majors only",
			Result: conditions2.NewMajorConditionWithDegreeLevel("International Management Studies", constants.PhD),
		},
	}

	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Major_condition), tc.Result)
		})
	}
}
...
func TestVisitDegreeCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Bachelors or Masters degree in subject list": {
			...
			Result: conditions2.NewOrCondition(
				conditions2.NewDegreeCondition("psychology"),
				conditions2.NewDegreeCondition("computer science"),
				conditions2.NewDegreeCondition("neuroscience"),
			),
		},
	}
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Degree_condition), tc.Result)
		})
	}
}
...
func TestVisitCoreCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Completion of core number": {
			...
			Result: conditions2.NewCoreCondition("050", "Creative Arts"),
		},
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Core_condition), tc.Result)
		})
	}
}
...
func TestVisitAnyCoreSCHCondition(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Any_core_condition), tc.Result)
		})
	}
}
...
func TestVisitCreditHoursCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"45 semester credit hours": {
			...
			Result: conditions2.NewCreditHoursCondition(45),
		},
	}
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Semester_credit_hours_condition), tc.Result)
		})
	}
}
...
func TestVisitMinimumHoursCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Minimum of 3 SCH of": {
			...
			Result: conditions2.NewCreditHoursFromCondition(3, []constants.Course{
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Minimum_hours_condition), tc.Result)
		})
	}
...
func TestVisitUpperDivisionHoursCondition(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Upper_division_hours_condition), tc.Result)
		})
	}
}
...
func TestVisitUpperDivisionClassesCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"At least three CS 43XX classes": {
			...
			Result: conditions2.NewUpperDivisionCountCondition(3, "CS"),
		},
		"A 4000-level course": {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Upper_division_classes_condition), tc.Result)
		})
	}
}
...
func TestVisitResearchCondition(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Research_condition), tc.Result)
		})
	}
}
...
func TestVisitCompleteNOfFollowingCondition(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Complete_n_condition), tc.Result)
		})
	}
}
...
func TestVisitPlacementTestCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Placement score less than": {
			...
			Result: conditions2.NewPlacementTestScoreCondition("Arabic Language Placement Test", 0, 20),
		},
		"Placement score greater than": {
			Input:  "Chinese Language Placement score greater than 80",
			Result: conditions2.NewPlacementTestScoreCondition("Chinese Language Placement", 80, 100),
		},
		"Placement score range": {
			Input:  "Arabic Language Placement score of 20-39",
			Result: conditions2.NewPlacementTestScoreCondition("Arabic Language Placement", 20, 39),
		},
		"Placement score range with Test in name": {
			Input:  "Japanese Language Place Test Score of 51-60",
			Result: conditions2.NewPlacementTestScoreCondition("Japanese Language Place Test", 51, 60),
		},
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Placement_test_condition), tc.Result)
		})
	}
}
...
func TestVisitApScoreCondition(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Ap_score_condition), tc.Result)
		})
	}
}
...
func TestVisitAleksScoreCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Minimal placement score of 85% on ALEKS": {
			...
			Result: conditions2.NewAleksScoreCondition(85),
		},
	}

	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Aleks_score_condition), tc.Result)
		})
	}
}
...
func TestVisitStudentGroupCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Students in both groups": {
			...
			Result: conditions2.NewAndCondition(
				conditions2.NewStudentGroupCondition(constants.LiberalArtsHonors),
				conditions2.NewStudentGroupCondition(constants.CollegeVHonors),
			),
		},
		"Multiple groups": {
			Input: "SCVG and DLAH student groups only",
			Result: conditions2.NewOrCondition(
				conditions2.NewStudentGroupCondition(constants.SCVG),
				conditions2.NewStudentGroupCondition(constants.DLAH),
			),
		},
		"CV Honors students only": {
			Input:  "CV Honors Students only",
			Result: conditions2.NewStudentGroupCondition(constants.CollegeVHonors),
		},
		"SCVG group": {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Group_condition), tc.Result)
		})
	}
}
...
func TestVisitConcurrentEnrollmentCondition(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Concurrent_enrollment_condition), tc.Result)
		})
	}
}
...
func TestVisitExactSectionCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"BIOL 2311.501": {
			Input: "BIOL 2311.501",
			Result: conditions2.NewAndCondition(
				conditions2.NewExactSectionCondition(constants.Course{Prefix: "BIOL", Number: "2311", Section: "501"}),
			),
		},
		"BIOL 2111.502": {
			Input: "BIOL 2111.502",
			Result: conditions2.NewAndCondition(
				conditions2.NewExactSectionCondition(constants.Course{Prefix: "BIOL", Number: "2111", Section: "502"}),
			),
		},
	}
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Exact_section_condition), tc.Result)
		})
	}
}
...
func TestVisitWorkshopSectionCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Workshop section": {
			...
			Result: conditions2.NewAndCondition(
				conditions2.NewExactSectionCondition(constants.Course{Prefix: "BIOL", Number: "2112", Section: "501"}),
			),
		},
	}
...
func TestVisitAnyPreviousMajorCourseCondition(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Any_major_course_condition), tc.Result)
		})
	}
}
...
func TestVisitAcademicPlanCondition(t *testing.T) {
	testCases := map[string]struct {
		...
		"Academic Plan Not Equal": {
			...
			Result: conditions2.NewAcademicYearCondition("BSANMSNF", false),
		},
	}

	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			testTree[conditions2.Condition](t, tc.Input, rule((*parser.RequirementsParser).Academic_plan_condition), tc.Result)
		})
	}
}
